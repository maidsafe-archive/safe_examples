...
const newNetStatusCallback = (dispatch) => function (state) {
  dispatch({
...
export const receiveResponse = (uri) => function (dispatch, getState) {
...
export const authoriseApplication = () => function (dispatch) {
  return dispatch({
    type: ACTION_TYPES.AUTHORISE_APP,
...
export const reconnectApplication = () => function (dispatch, getState) {
  const app = getState().initialiser.app;
  return dispatch({
